...
csv_file = "/root/backup/scripts/olts.csv"
...
# Configuração do log
log_directory = f"/root/backup/{cliente}/OLT/log"
os.makedirs(log_directory, exist_ok=True)  # Garantir que o diretório de log exista
log_filename = os.path.join(log_directory, 'backup_olt_huawei.log')
...
def backup_device(host, username, password, port, identificacao):
    ...
    try:
        ...
        backup_dir = f"/root/backup/{cliente}/OLT"
        ...
        redundancy_backup_dir = f"/mnt/backup/{cliente}/OLT"
